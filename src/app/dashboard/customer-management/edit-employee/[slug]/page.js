    ...
    (async () => {
      await axios
        ...
        ?.then((res) => {
          ...
          setEmployeeID(res?.data?.data?.professional_details?.id || "");
          setUserName(res?.data?.data?.professional_details?.userName || "");
          setEmployeeType(res?.data?.data?.professional_details?.type || "");
          setDepartment(
          ...
          <div className="w-full grid grid-cols-4 gap-16 mt-10">
            ...
            <div className="flex flex-col gap-3 font-light">
              ...
              {isEditing ? (
                ...
                <div className="flex flex-col gap-3">
                  <p className="text-sm">{DOB?.slice(0, 10)}</p>
                  <div className="h-[1px] w-52 bg-gray-200" />
                </div>
              )}
            </div>
          ...
          <div className="w-full grid grid-cols-4 gap-16 mt-10">
            ...
            <div className="flex flex-col gap-3 font-light">
              ...
              {isEditing ? (
                ...
                <div className="flex flex-col gap-3">
                  <p className="text-sm">{professionalEmail}</p>
                  <div className="h-[1px] w-52 bg-gray-200" />
                </div>
              )}
            </div>
