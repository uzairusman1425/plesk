        ...
        <div className="h-full flex-1 flex items-center justify-center">
            <div className="size-[95%] border border-gray-400 rounded-xl p-10 flex flex-col gap-5">
                <div className="w-full flex flex-row items-center justify-between">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row gap-3 items-center">
                            <Image src={"/icons/designation.png"} alt="designation" height={25} width={25} />
                            <p className="font-light">Project Manager</p>
                        </div>
                        <div className="flex flex-row gap-3 items-center">
                            <Image src={"/icons/email.png"} alt="designation" height={25} width={25} />
                    ...
                    <button className="h-14 w-40 rounded-xl bg-primary flex flex-row gap-3 items-center justify-center">
                        <Image src={"/icons/edit-white.png"} alt="edit" height={25} width={25} />
                ...
                <div className="w-[50%] border-b flex flex-row items-center gap-5">
                    <button 
                        className={`h-10 flex flex-row gap-3 items-center px-1 ${selectedTab === "personal" ? "border-b-2 border-primary" : "border-b-2 border-transparent"}`} 
                        onClick={() => {
                    ...
                    >
                        <Image src={selectedTab === "personal" ? "/icons/personal-information-blue.png" : "/icons/personal-information.png"} alt="personal-information" height={25} width={25} />
                        <p className={`text-sm ${selectedTab === "personal" ? "font-semibold text-primary" : ""}`}>Personal Information</p>
                    </button>
                    <button 
                        className={`h-10 flex flex-row gap-3 items-center px-1 ${selectedTab === "professional" ? "border-b-2 border-primary" : "border-b-2 border-transparent"}`} 
                        onClick={() => {
                    ...
                    >
                        <Image src={selectedTab === "professional" ? "/icons/professional-information-blue.png" : "/icons/professional-information.png"} alt="professional-information" height={20} width={20} />
                        <p className={`text-sm ${selectedTab === "professional" ? "font-semibold text-primary" : ""}`}>Professional Information</p>
                    </button>
                </div>
                {selectedTab === "personal" ? (
                    ...
                    <div className="w-full grid grid-cols-4 gap-16 mt-10">
                        ...
                        <div className="flex flex-col gap-3 font-light">
                            <p className="text-xs text-gray-400">Employee Type</p>
